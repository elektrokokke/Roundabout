...
public:
    MidiNoteOnEvent(unsigned char channel, unsigned char noteNumber, unsigned char velocity) :
            MidiEvent(3)
    {
...
public:
    MidiNoteOffEvent(unsigned char channel, unsigned char noteNumber, unsigned char velocity) :
            MidiEvent(3)
    {
